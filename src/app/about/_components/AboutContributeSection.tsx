  ...
  return (
    <section className="mt-10 space-y-4">
      ...
      <p className="text-sm text-secondary">
        The platform is currently being built as an open-source project. If you
        want to help shape it, report issues or just reach out, you can use the
        GitHub repository:
      </p>
      ...
      <ul className="list-disc space-y-2 pl-5 text-sm text-secondary">
        ...
        <li>
          Use GitHub to contact me directly if you have questions or want to
          collaborate.
        </li>
      </ul>
